...
class SimpleLinearRegression:
    ...
    def create_dataset(n, variance, correlation, step=2):
        ...
        for i in range(n):  # number of elements that will be appended to 'y'
            ...
            # Now depending on the correlation parameter, the next element base value is increased on decreases
...
if __name__ == '__main__':
    ...
    # Define a classifier and initialize the Quality sub-class to measure the accuracy of you model.
    ...
    X_train, y_train = clf.create_dataset(50, 20, correlation='pos')
    X_test, y_test = clf.create_dataset(50, 20, correlation='pos')

    # The fit() method returns intercept and slope in a tuple like this -> (intercept, slope)
    b, m = clf.fit(X_train, y_train)

    # Create a best fit line by making a list of all the features corresponding to estimated intercept and slope.
